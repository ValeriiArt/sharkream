...
export const locations: LocationsData = [
    {
        name: "Паркове Місто",
        srcImage: "../public/images/roller-school/roller-4.webp",
        srcLocation: 'https://goo.gl/maps/QSf1foye2cvEFmLW7?coh=178571&entry=tt'
    },
    {
        name: "ТЦ Променада",
        srcImage: "../public/images/roller-school/roller-3.webp",
       srcLocation: 'https://goo.gl/maps/kHuyPc9pXbD1dCJGA?coh=178571&entry=tt'
    },
    {
        name: "Парк Наталка",
        srcImage: "../public/images/roller-school/roller-5.webp",
